                ...
                """),format.raw/*34.17*/("""<div class="col-md-4 text-center">
                    <div class="panel panel-success panel-pricing">
                        ...
                        <div class="panel-body text-center">
                            <p><strong>€ """),_display_(/*42.43*/("%.2f".format(t.getPrice))),format.raw/*42.70*/("""</strong></p>
                        </div>
