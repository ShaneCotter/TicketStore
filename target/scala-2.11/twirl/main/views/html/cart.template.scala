        ...
        <div class="row">
            <div class="col-lg-8 col-lg-offset-2">
                <div class="panel panel-info">
                                    ...
                                    <div class="col-xs-6">
                                        ...
                                        <div class="col-xs-4 pull-right">
                                            ...
                                            """),_display_(/*69.46*/if(i.getQuantity == i.getTicket.getQuantity)/*69.90*/ {_display_(Seq[Any](format.raw/*69.92*/("""
                                                ...
                                                Max reached
                                            """)))}),format.raw/*74.46*/("""
                                        """),format.raw/*75.41*/("""</div>
                                    </div>
                                </div>
                                <hr>
                                """)))}),format.raw/*79.34*/("""

                        """),format.raw/*81.25*/("""<div class="row">
                            <div class="text-center">
                                <div class="col-xs-9">
                                    <h6 class="text-right">Empty cart</h6>
                                </div>
                                <div class="col-xs-3">
                                    <a href=""""),_display_(/*87.47*/routes/*87.53*/.ShoppingCtrl.emptyBasket()),format.raw/*87.80*/("""" class="btn btn-danger btn-sm" onclick="return confirmDel();">
                                        Empty Cart</a>
                                </div>
                            </div>
                        </div>
                    ...
                    """),format.raw/*96.21*/("""<div class="panel-footer">
                        <div class="row text-center">
                            <div class="col-xs-9">
                                <h4 class="text-right"><strong>
                                    Total: &euro; """),_display_(/*100.52*/("%.2f".format(user.getBasket.getBasketTotal))),format.raw/*100.98*/("""</strong></h4>
                            </div>
                            """),_display_(/*102.30*/if(user.getBasket.getBasketTotal > 0)/*102.67*/ {_display_(Seq[Any](format.raw/*102.69*/("""
                                """),format.raw/*103.33*/("""<div class="col-xs-3">
                                    <form action="/placeOrder" method="GET">
                                        <script
                                        src="https://checkout.stripe.com/checkout.js" class="stripe-button btn-success"
                                        data-key="pk_test_6pRNASCoBOKtIshFeQd4XMUh"
                                        data-amount=""""),_display_(/*108.55*/user/*108.59*/.getBasket.getStripeTotal),format.raw/*108.84*/(""""
                                        data-name="TC Events"
                                        data-description="Payment"
                                        data-email=""""),_display_(/*111.54*/user/*111.58*/.getEmail()),format.raw/*111.69*/(""""
                                        data-currency="EUR"
